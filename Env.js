function Env(t, e) {
  ...
  return new class {
    ...
    async runScript(t, e) {
      try {
        return new Promise(s =>{
          ...
          const[o, h] = i.split("@"),
          n = {
            url: `http: //${h}/v1/scripting/evaluate`, body: { script_text: t, mock_type: "cron", timeout: r }, headers: { "X-Key": o, Accept: "*/*" }
          };
          this.post(n, (t_3, e_1, i_1) =>s(i_1));
        });
      } catch(t_4) {
        return this.logErr(t_4);
      }
    }
    loaddata() {
    ...
    get(t, e = (() =>{})) {
      if (t.headers && (delete t.headers["Content-Type"], delete t.headers["Content-Length"]), this.isSurge() || this.isLoon()) this.isSurge() && this.isNeedRewrite && (t.headers = t.headers || {},
      ...
      else if (this.isQuanX()) this.isNeedRewrite && (t.opts = t.opts || {},
    ...
    post(t, e = (() =>{})) {
      ...
      $httpClient[s](t, (t, s, i) =>{ ! t && s && (s.body = i, s.statusCode = s.status),
        e(t, s, i)
      });
      else if (this.isQuanX()) t.method = s,
